...
urlpatterns += patterns('',
    ...
    url(r'^api/get_history_stream/$', 'main.api_views.get_history_stream'),
    ...
    url(r'^api/get_community_empty_nominations/$', 'main.api_views.get_community_empty_nominations'),
