...
// in simulator we redefine to format for Portrit Developer console
...
{\
	NSString * exceptionName = [@"org.portrit." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.portrit";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIPortritNativeItemNone = -1, 
	UIPortritNativeItemSpinner = -2,
	UIPortritNativeItemProgressBar = -3,
	
	UIPortritNativeItemSlider = -4,
	UIPortritNativeItemSwitch = -5,
	UIPortritNativeItemMultiButton = -6,
	UIPortritNativeItemSegmented = -7,
	
	UIPortritNativeItemTextView = -8,
	UIPortritNativeItemTextField = -9,
	UIPortritNativeItemSearchBar = -10,
	
	UIPortritNativeItemPicker = -11,
	UIPortritNativeItemDatePicker = -12,
	
	UIPortritNativeItemInfoLight = -13,
	UIPortritNativeItemInfoDark = -14,
	
	UIPortritNativeItemDisclosure = -15,
	
	UIPortritNativeItemContactAdd = -16
};
