...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Portrit_User.portrit_photos_album_fid'
        db.add_column('main_portrit_user', 'portrit_photos_album_fid', self.gf('main.models.BigIntegerField')(unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Portrit_User.portrit_photos_album_fid'
        db.delete_column('main_portrit_user', 'portrit_photos_album_fid')
