...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Notification.destination'
        db.add_column('main_notification', 'destination', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notification_destination', null=True, to=orm['main.FB_User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Notification.destination'
        db.delete_column('main_notification', 'destination_id')
