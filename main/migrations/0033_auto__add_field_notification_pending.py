...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Notification.pending'
        db.add_column('main_notification', 'pending', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Notification.pending'
        db.delete_column('main_notification', 'pending')
