...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field portrit_user_album on 'Portrit_User'
        db.delete_table('main_portrit_user_portrit_user_album')

        # Adding M2M table for field portrit_user_albums on 'Portrit_User'
        db.create_table('main_portrit_user_portrit_user_albums', (
        ...
        db.create_unique('main_portrit_user_portrit_user_albums', ['portrit_user_id', 'album_id'])


    def backwards(self, orm):
        
        # Adding M2M table for field portrit_user_album on 'Portrit_User'
        db.create_table('main_portrit_user_portrit_user_album', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('portrit_user', models.ForeignKey(orm['main.portrit_user'], null=False)),
            ('album', models.ForeignKey(orm['main.album'], null=False))
        ))
        db.create_unique('main_portrit_user_portrit_user_album', ['portrit_user_id', 'album_id'])

        # Removing M2M table for field portrit_user_albums on 'Portrit_User'
        db.delete_table('main_portrit_user_portrit_user_albums')
    ...
    models = {
        ...
        'main.portrit_user': {
            ...
            'portrit_user_albums': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['main.Album']", 'null': 'True', 'blank': 'True'}),
