...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FB_User.active'
        db.add_column('main_fb_user', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'FB_User.pending'
        db.add_column('main_fb_user', 'pending', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Portrit_User.pending'
        db.add_column('main_portrit_user', 'pending', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FB_User.active'
        db.delete_column('main_fb_user', 'active')

        # Deleting field 'FB_User.pending'
        db.delete_column('main_fb_user', 'pending')

        # Deleting field 'Portrit_User.pending'
        db.delete_column('main_portrit_user', 'pending')
