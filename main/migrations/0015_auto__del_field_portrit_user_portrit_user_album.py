...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Portrit_User.portrit_user_album'
        db.delete_column('main_portrit_user', 'portrit_user_album_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Portrit_User.portrit_user_album'
        db.add_column('main_portrit_user', 'portrit_user_album', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Album'], null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'main.portrit_user': {
            ...
            'portrit_user_album': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['main.Album']", 'null': 'True', 'blank': 'True'}),
