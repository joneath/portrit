...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('main_photo', 'photo')

        # Adding field 'Photo.portrit_photo'
        db.add_column('main_photo', 'portrit_photo', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Photo.thumbnail_src'
        db.add_column('main_photo', 'thumbnail_src', self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Photo.large_src'
        db.add_column('main_photo', 'large_src', self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Photo.photo'
        db.add_column('main_photo', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'Photo.portrit_photo'
        db.delete_column('main_photo', 'portrit_photo')

        # Deleting field 'Photo.thumbnail_src'
        db.delete_column('main_photo', 'thumbnail_src')

        # Deleting field 'Photo.large_src'
        db.delete_column('main_photo', 'large_src')
