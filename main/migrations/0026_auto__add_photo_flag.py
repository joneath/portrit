...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Photo_Flag'
        db.create_table('main_photo_flag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('flagger', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Portrit_User'], null=True, blank=True)),
        ))
        db.send_create_signal('main', ['Photo_Flag'])

        # Adding M2M table for field flags on 'Photo'
        db.create_table('main_photo_flags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('photo', models.ForeignKey(orm['main.photo'], null=False)),
            ('photo_flag', models.ForeignKey(orm['main.photo_flag'], null=False))
        ))
        db.create_unique('main_photo_flags', ['photo_id', 'photo_flag_id'])


    def backwards(self, orm):
        
        # Deleting model 'Photo_Flag'
        db.delete_table('main_photo_flag')

        # Removing M2M table for field flags on 'Photo'
        db.delete_table('main_photo_flags')
