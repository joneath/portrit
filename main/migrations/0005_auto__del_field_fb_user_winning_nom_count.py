...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'FB_User.winning_nom_count'
        db.delete_column('main_fb_user', 'winning_nom_count')

        # Adding M2M table for field winning_noms on 'FB_User'
        db.create_table('main_fb_user_winning_noms', (
        ...
        db.create_unique('main_fb_user_winning_noms', ['fb_user_id', 'nomination_id'])


    def backwards(self, orm):
        
        # Adding field 'FB_User.winning_nom_count'
        db.add_column('main_fb_user', 'winning_nom_count', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)

        # Removing M2M table for field winning_noms on 'FB_User'
        db.delete_table('main_fb_user_winning_noms')
