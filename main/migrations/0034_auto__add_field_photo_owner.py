...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_photo', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Portrit_User'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.owner'
        db.delete_column('main_photo', 'owner_id')
