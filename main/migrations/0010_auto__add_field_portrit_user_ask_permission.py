...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Portrit_User.ask_permission'
        db.add_column('main_portrit_user', 'ask_permission', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Portrit_User.ask_permission'
        db.delete_column('main_portrit_user', 'ask_permission')
    ...
    models = {
        ...
        'main.portrit_user': {
            ...
            'ask_permission': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
