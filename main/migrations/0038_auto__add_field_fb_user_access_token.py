...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FB_User.access_token'
        db.add_column('main_fb_user', 'access_token', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FB_User.access_token'
        db.delete_column('main_fb_user', 'access_token')
