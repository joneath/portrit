...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User_Followers.pending_notification'
        db.add_column('main_user_followers', 'pending_notification', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Notification'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'User_Followers.pending_notification'
        db.delete_column('main_user_followers', 'pending_notification_id')
