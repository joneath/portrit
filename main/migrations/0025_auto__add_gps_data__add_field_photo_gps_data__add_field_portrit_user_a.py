...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GPS_Data'
        db.create_table('main_gps_data', (
            ...
            ('altitudeAccuracy', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal('main', ['GPS_Data'])

        # Adding field 'Photo.gps_data'
        db.add_column('main_photo', 'gps_data', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.GPS_Data'], null=True, blank=True), keep_default=False)

        # Adding field 'Portrit_User.allow_gps_data'
        db.add_column('main_portrit_user', 'allow_gps_data', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'GPS_Data'
        db.delete_table('main_gps_data')

        # Deleting field 'Photo.gps_data'
        db.delete_column('main_photo', 'gps_data_id')

        # Deleting field 'Portrit_User.allow_gps_data'
        db.delete_column('main_portrit_user', 'allow_gps_data')
    ...
    models = {
        ...
        'main.portrit_user': {
            ...
            'followers': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'portrit_user_followers'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['main.FB_User']"}),
            'following': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'portrit_user_following'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['main.FB_User']"}),
