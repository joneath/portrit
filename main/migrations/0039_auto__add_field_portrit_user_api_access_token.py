...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Portrit_User.api_access_token'
        db.add_column('main_portrit_user', 'api_access_token', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Portrit_User.api_access_token'
        db.delete_column('main_portrit_user', 'api_access_token')
