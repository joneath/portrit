...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_user_following', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('portrit_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Portrit_User'])),
            ('fb_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.FB_User'])),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('pending', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('main', ['User_Following'])

        # Adding model 'User_Followers'
        db.create_table('main_user_followers', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('portrit_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Portrit_User'])),
            ('fb_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.FB_User'])),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ...
        db.send_create_signal('main', ['User_Followers'])

        # Deleting field 'Portrit_User.user'
        db.delete_column('main_portrit_user', 'user_id')

        # Removing M2M table for field followers on 'Portrit_User'
        db.delete_table('main_portrit_user_followers')

        # Removing M2M table for field following on 'Portrit_User'
        db.delete_table('main_portrit_user_following')


    def backwards(self, orm):
        
        # Deleting model 'User_Following'
        db.delete_table('main_user_following')

        # Deleting model 'User_Followers'
        db.delete_table('main_user_followers')

        # Adding field 'Portrit_User.user'
        db.add_column('main_portrit_user', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)

        # Adding M2M table for field followers on 'Portrit_User'
        db.create_table('main_portrit_user_followers', (
        ...
        db.create_unique('main_portrit_user_followers', ['portrit_user_id', 'fb_user_id'])

        # Adding M2M table for field following on 'Portrit_User'
        db.create_table('main_portrit_user_following', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('portrit_user', models.ForeignKey(orm['main.portrit_user'], null=False)),
            ('fb_user', models.ForeignKey(orm['main.fb_user'], null=False))
        ))
        db.create_unique('main_portrit_user_following', ['portrit_user_id', 'fb_user_id'])
