...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field blocked_users on 'Portrit_User'
        db.create_table('main_portrit_user_blocked_users', (
        ...
        db.create_unique('main_portrit_user_blocked_users', ['portrit_user_id', 'fb_user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field blocked_users on 'Portrit_User'
        db.delete_table('main_portrit_user_blocked_users')
    ...
    models = {
        ...
        'main.portrit_user': {
            ...
            'blocked_users': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'portrit_blocked_users'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['main.FB_User']"}),
