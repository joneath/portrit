...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Portrit_User.portrit_album_fid'
        db.add_column('main_portrit_user', 'portrit_album_fid', self.gf('main.models.BigIntegerField')(unique=True, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Portrit_User.portrit_album_fid'
        db.delete_column('main_portrit_user', 'portrit_album_fid')
    ...
    models = {
        ...
        'main.portrit_user': {
            ...
            'allow_portrit_album': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'portrit_album_fid': ('main.models.BigIntegerField', [], {'unique': 'True', 'null': 'True'}),
