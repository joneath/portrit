...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Portrit_User.portrit_user_album_fid'
        db.delete_column('main_portrit_user', 'portrit_user_album_fid')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Portrit_User.portrit_user_album_fid'
        db.add_column('main_portrit_user', 'portrit_user_album_fid', self.gf('main.models.BigIntegerField')(unique=True, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'main.portrit_user': {
            ...
            'portrit_user_album': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Album']", 'null': 'True', 'blank': 'True'}),
