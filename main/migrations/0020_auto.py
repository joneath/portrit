...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field tagged_friends on 'Nomination'
        db.create_table('main_nomination_tagged_friends', (
        ...
        db.create_unique('main_nomination_tagged_friends', ['nomination_id', 'fb_user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field tagged_friends on 'Nomination'
        db.delete_table('main_nomination_tagged_friends')
