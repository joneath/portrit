...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Portrit_User.nickname'
        db.delete_column('main_portrit_user', 'nickname')

        # Adding field 'Portrit_User.username'
        db.add_column('main_portrit_user', 'username', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Portrit_User.nickname'
        db.add_column('main_portrit_user', 'nickname', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)

        # Deleting field 'Portrit_User.username'
        db.delete_column('main_portrit_user', 'username')
