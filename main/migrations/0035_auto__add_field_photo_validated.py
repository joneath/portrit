...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.validated'
        db.add_column('main_photo', 'validated', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.validated'
        db.delete_column('main_photo', 'validated')
