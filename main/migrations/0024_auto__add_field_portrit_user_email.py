...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Portrit_User.email'
        db.add_column('main_portrit_user', 'email', self.gf('django.db.models.fields.EmailField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Portrit_User.email'
        db.delete_column('main_portrit_user', 'email')
