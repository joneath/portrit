...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_photo', 'album', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Album'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('main_photo', 'album_id')
