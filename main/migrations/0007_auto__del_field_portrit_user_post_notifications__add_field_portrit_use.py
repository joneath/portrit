...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Portrit_User.post_notifications'
        db.delete_column('main_portrit_user', 'post_notifications')

        # Adding field 'Portrit_User.allow_notifications'
        db.add_column('main_portrit_user', 'allow_notifications', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Portrit_User.post_notifications'
        db.add_column('main_portrit_user', 'post_notifications', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'Portrit_User.allow_notifications'
        db.delete_column('main_portrit_user', 'allow_notifications')
