...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Portrit_User.fb_friends_imported'
        db.add_column('main_portrit_user', 'fb_friends_imported', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Portrit_User.fb_friends_imported'
        db.delete_column('main_portrit_user', 'fb_friends_imported')
