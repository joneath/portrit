...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Portrit_User.allow_follows'
        db.add_column('main_portrit_user', 'allow_follows', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Portrit_User.allow_follows'
        db.delete_column('main_portrit_user', 'allow_follows')
